...
import CustomStakesTableRow from './CustomStakesTableRow';

const CustomStakesTable = ({ headers, list, currentId, setCurrenId }) => {
  return (
      ...
      <ScrollableComponent className="w-full max-h-[calc(100vh-595px)]">
        <div>
          {list.map((h, i) => (
            ...
            >
              <CustomStakesTableRow thisId={i} tRow={h} setCurrenId={setCurrenId} />
            </div>
          ))}
        </div>
      </ScrollableComponent>
